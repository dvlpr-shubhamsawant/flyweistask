              ...
              Consumer<ProductController>(builder: (context, controller, _) {
                return Container(
                    ...
                    child: controller.isLoading == true
                        ...
                        : controller.products?.data?.length == 0
                            ? Center(
                                        ...
                                        child: Column(
                                          children: [
                                            SizedBox(
                                              ...
                                              // color: green,
                                              child: Image.network(
                                                '${controller.products!.data![index].image![0].url}',
                                                fit: BoxFit.cover,
                                                width: 100.w,
                                              ),
                                            ),
                                            Padding(
                                              ...
                                              child: Row(
                                                children: [
                                                  Text(
                                                    '${controller.products!.data![index].productName}',
                                                    style: TextStyle(
                                                        color: black,
                                                        fontSize: 13.px,
                                                        fontWeight:
                                            ...
                                            Padding(
                                              ...
                                              child: Align(
                                                  ...
                                                  child: Text(
                                                    '${controller.products!.data![index].description}',
                                                    maxLines: 2,
                                                    style: TextStyle(
                                            ...
                                            Padding(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  Text(
                                                    '₹${controller.products!.data![index].discountPrice}',
                                                    style: TextStyle(
                                                        color: black,
                                                        fontSize: 13.px,
                                                        fontWeight:
                                                  ...
                                                  Spacer(),
                                                  Text(
                                                    'MOQ: ${controller.products!.data![index].stock}',
                                                    style: GoogleFonts.poppins(
                                                        fontWeight:
                                                            FontWeight.w400,
                                                        fontSize: 13.px),
                                            ...
                                            Padding(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  Text(
                                                    '₹${controller.products!.data![index].originalPrice}',
                                                    style: TextStyle(
                                                        decoration:
                                                            TextDecoration
                                                                .lineThrough,
                                                  ...
                                                  sizedBoxWidth10,
                                                  Text(
                                                    '${controller.products!.data![index].discount}%Off',
                                                    style: GoogleFonts.poppins(
                                                        fontWeight:
                                                            FontWeight.w400,
                                                        fontSize: 13.px,
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  '${controller.products!.data![index].numOfReviews}',
                                                  style: TextStyle(
                                                      color: grey,
                                                      fontSize: 12.px),
                                                )
