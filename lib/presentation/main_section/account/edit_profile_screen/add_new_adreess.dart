...
class AddNewAddressScreen extends StatelessWidget {
  ...
  TextEditingController alternativeNo = TextEditingController();
          ...
          child: Column(children: [
            ...
            Align(
                ...
                child: Text(
                  'Pin code',
                  style:
                      GoogleFonts.poppins(fontSize: 14.px, color: Colors.blue),
                )).pSymmetric(h: 4.w),
            TextFormField(
              controller: pincode,
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                hintStyle: GoogleFonts.poppins(
                    fontSize: 14.px, color: grey, fontWeight: FontWeight.w500),
                enabledBorder: UnderlineInputBorder(
                  borderSide: BorderSide(color: Colors.black),
                ),
                focusedBorder: UnderlineInputBorder(
            ...
            ButtonWidget(
                ...
                .onTap(() {
              AddresssController().createAddress(
                name: AppUser().name,
                add1: add1.text,
                add2: add2.text,
